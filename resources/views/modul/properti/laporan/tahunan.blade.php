            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white p-8 rounded-[40px] shadow-[0_20px_40px_rgba(0,0,0,0.04)]">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold">Laporan Tahunan</h3>
                    </div>
                        ...
                        <table class="w-full text-left">
                            <thead class="sticky top-0 bg-white z-10">
                                <tr class="text-gray-400 text-sm border-b">
                                    ...
                                    <th class="pb-4 font-semibold">Tahun</th>
                                    <th class="pb-4 font-semibold">Jumlah Project</th>
                                    <th class="pb-4 font-semibold text-right">Aksi</th>
                                </tr>
                            </thead>
                            <tbody class="text-sm">
                                <tr>
                                    <td colspan="4" class="text-center py-8 text-gray-400 italic">Belum ada laporan tahunan.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
